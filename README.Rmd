...
ArgosQC workflows can be run via single functions, specific to the Program (ATN, IMOS, etc...) and the tag manufacturer - currently, SMRU (`smru`) or Wildlife Computers (`wc`):
