test_that("wc_qc works", {
  ...
  wc_qc(getwd(), "config_lhtu_wc.json")
  ...
  expect_true(file.exists("test/lat_coverage_.jpg"))
  expect_true(file.exists("test/lon_coverage_.jpg"))
  expect_true(file.exists(paste0("test/map_", Sys.Date(), ".png")))
